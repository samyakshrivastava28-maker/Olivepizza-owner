...
export default function FranchiseManager() {
  ...
  const handleOpenEdit = (branch: FranchiseBranch) => {
    ...
    setEditForm({
      ...
      phone: branch.phone || '',
      email: branch.email || '',
      franchiseOwnerName: (branch as any).franchiseOwnerName || '',
      franchiseOwnerEmail: branch.franchiseOwnerEmail || '',
      restaurantManagerName: (branch as any).restaurantManagerName || '',
      restaurantManagerEmail: branch.restaurantManagerEmail || '',
      openingTime: branch.openingTime || '12:00',
      closingTime: branch.closingTime || '23:59',
      maxDeliveryRadiusKm: Number(branch.maxDeliveryRadiusKm) || 12,
